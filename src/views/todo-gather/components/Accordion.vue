  ...
  <div class="Accordion">
    <!-- Accordion Title -->
    <div class="gather-title-wrap">
      <div class="gather-left"></div>
      <div class="AccordionTitle">
        <div class="AccordionTitleL LEFTTEXT"
             v-text="AccordionData"
             v-show="true"></div>
        <div class="AccordionTitleR-wrap">
          <div class=" LEFTTEXT slot-second"
    ...
    <div class="AccordionBody"
         ref="AccordionBody">
      <!-- 接受slot的容器 -->
      <!-- 这里我采用slot的方法把手风琴内的内容插件里，以方便控制，达到灵活的效果 -->
      <div class="ContentA">
